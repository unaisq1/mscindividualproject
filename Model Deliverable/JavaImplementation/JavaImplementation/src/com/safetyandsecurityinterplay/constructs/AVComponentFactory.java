...
public class AVComponentFactory {
    ...
    public static EmergencyBrakingSystem buildSharedProcessorVariant() {
        List<Sensor> sensors = List.of(Camera1);
        AuthenticationSystem auth = new AuthenticationSystem("AuthAlgorithm", 15, 256);
    ...
    public static EmergencyBrakingSystem buildRedundancySharedProcessorVariant() {
    ...
    //Variant C: triple redundant, three sensors, with dedicated cryptography hardware.
    public static EmergencyBrakingSystem buildRedundancyDedicatedProcessorVariant() {
        List<Sensor> sensors = List.of(Camera1, LiDAR1, Radar1);
        AuthenticationSystem auth = new AuthenticationSystem("AuthAlgorithm", 15, 256);
        VotingSystem voting = new VotingSystem(2, Sensor.getNumberOfInstances());
